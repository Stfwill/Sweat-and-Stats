const CACHE="sweat-and-stats-v2-4-0-2-1";
const ASSETS=["./","./index.html","./manifest.json","./cova-flex.png","./cova-point.png","./cova-wave.png","./patch-2.4.0.2.1.css","./patch-2.4.0.2.1.js","./firestore.rules"];
