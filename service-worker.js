const CACHE="sweat-and-stats-v2-2-library-workflow-import";
const ASSETS=["./","./index.html","./manifest.json","./icon-64.png","./icon-192.png","./icon-512.png","./icon-maskable-512.png","./apple-touch-icon.png"];
